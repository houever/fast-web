...
<template>
  <div class="search">
    ...
    >
      <div slot="header">
        <div class="ivu-modal-header-inner">流程编辑</div>
...
<script>
  import {
    ...
    exportModel,
    deleteModel
  } from "@/api/activiti/model-manage";
  import circleLoading from '../../../my-components/circle-loading.vue'
    export default {
      ...
      methods: {
        ...
        edit(v) {
          this.modelerUrl = `http://localhost:8600/modeler.html?modelId=${v.id}&time=${new Date()}`;
        ...
        export(v) {
          window.open(
            `http://localhost:8600`+exportModel + v.id
          );
        },
        remove(v) {
          this.$Modal.confirm({
